...
go test ./internal/service -count=1 -run 'TestWikiSearch(DoesNotReturnGitOnlyPageWhenCatalogHasLiveRows|FallsBackToGitWithoutCatalogRows|UsesCatalogBodyWhenSearchIndexLagsCatalogPage|UsesCatalogLexicalWhenIndexedRowsMissLivePage)$'
