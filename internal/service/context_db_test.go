...
func openTenantTestDB(t *testing.T, prefix string) *gorm.DB {
	t.Helper()
	gdb, cleanup := testdb.OpenRaw(t, prefix)
	t.Cleanup(cleanup)
	return gdb
}
...
func TestDBForCtxUsesTenantDB(t *testing.T) {
	defaultDB := openTenantTestDB(t, "tenant_default")
	tenantDB := openTenantTestDB(t, "tenant_context")
...
func TestDBForCtxFallsBackToDefault(t *testing.T) {
	defaultDB := openTenantTestDB(t, "tenant_fallback")
...
func TestBackgroundGoroutinePropagatesTenantDB(t *testing.T) {
	defaultDB := openTenantTestDB(t, "tenant_bg_default")
	tenantDB := openTenantTestDB(t, "tenant_bg_tenant")
...
func TestContextHelpers(t *testing.T) {
	testDB := openTenantTestDB(t, "tenant_helpers")
