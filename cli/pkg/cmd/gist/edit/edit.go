...
func editRun(opts *EditOptions) error {
	...
	// If only description is being updated (no file changes), skip the file editing loop
	if opts.Description != "" && opts.AddFilename == "" && opts.RemoveFilename == "" &&
		opts.EditFilename == "" && opts.SourceFile == "" {
		if shouldUpdate {
