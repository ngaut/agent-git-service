...
- What can you do to make the CLI version [feel like the GitHub.com version](#make-it-feel-like-github), using [color](../foundations/#color), [language](../foundations/#language), [spacing](../foundations/#spacing), info shown, etc?
